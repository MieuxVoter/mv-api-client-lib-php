...
# Usage example: /bin/sh ./git_push.sh gitlab.com wing328 openapi-petstore-perl "minor update"
...
# I don't won't to write in my globals, and perhaps this deserves its own user?
