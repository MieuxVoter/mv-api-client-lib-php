...
/**
 * ProposalGradeResultJsonldRead Class Doc Comment
 *
 * @category Class
 * @description Results for one Grade of one Proposal, basically the tally of Ballots for this Grade and Proposal, but there might be more information in there in the future.
 * @package  MvApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProposalGradeResultJsonldRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProposalGradeResult:jsonld-read';
     ...
     * Sets grade
     *
     * @param string|null $grade The IRI of the Grade this Result is about.
     *
     * @return self
     */
     ...
     * Sets proposal
     *
     * @param string|null $proposal The IRI of the Proposal this Result is about.
     *
     * @return self
     */
     ...
     * Sets tally
     *
     * @param int|null $tally Amount of Ballots emitted for this Grade on the Proposal.
     *
     * @return self
     */
