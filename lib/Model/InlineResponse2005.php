...
class InlineResponse2005 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'hydramember' => '\MvApi\Model\UserJsonldRead[]',
     ...
     * Sets hydramember
     *
     * @param \MvApi\Model\UserJsonldRead[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (!is_null($hydratotal_items) && ($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling InlineResponse2005., must be bigger than or equal to 0.');
        }
