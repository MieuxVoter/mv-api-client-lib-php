 ...
 */
class PollCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Poll-create';
    ...
    protected static $openAPITypes = [
        ...
        'scope' => 'string',
        'subject' => 'string',
        'proposals' => '\MvApi\Model\ProposalCreate[]',
        'grades' => '\MvApi\Model\GradeCreate[]'
    ];
     ...
     * Gets proposals
     *
     * @return \MvApi\Model\ProposalCreate[]|null
     */
     ...
     * Sets proposals
     *
     * @param \MvApi\Model\ProposalCreate[]|null $proposals A list of Proposals to judge, that MUST contain at least two proposals, and can have at most 256 proposals but that upper limit is arbitrary and may wildly vary after benchmark and discussion.
     *
     * @return self
     */
     ...
     * Gets grades
     *
     * @return \MvApi\Model\GradeCreate[]|null
     */
     ...
     * Sets grades
     *
     * @param \MvApi\Model\GradeCreate[]|null $grades A list of Grades that Participants may give to Proposals – That list MUST contain at least two Grades, and at most 16 (another arbitrary limit to discuss).
     *
     * @return self
     */
