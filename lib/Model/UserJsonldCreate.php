...
/**
 * UserJsonldCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class UserJsonldCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User:jsonld-create';
     ...
     * Sets password
     *
     * @param string|null $password The plain password of the User.
     *
     * @return self
     */
