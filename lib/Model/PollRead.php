 ...
 */
class PollRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Poll-read';
    ...
    protected static $openAPITypes = [
        ...
        'scope' => 'string',
        'subject' => 'string',
        'proposals' => '\MvApi\Model\ProposalRead[]',
        'grades' => '\MvApi\Model\GradeRead[]',
     ...
     * Sets proposals
     *
     * @param \MvApi\Model\ProposalRead[]|null $proposals A list of Proposals to judge, that MUST contain at least two proposals, and can have at most 256 proposals but that upper limit is arbitrary and may wildly vary after benchmark and discussion.
     *
     * @return self
     */
     ...
     * Sets grades
     *
     * @param \MvApi\Model\GradeRead[]|null $grades A list of Grades that Participants may give to Proposals – That list MUST contain at least two Grades, and at most 16 (another arbitrary limit to discuss).
     *
     * @return self
     */
