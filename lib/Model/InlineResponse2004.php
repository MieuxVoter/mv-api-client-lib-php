...
class InlineResponse2004 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'hydramember' => '\MvApi\Model\BallotJsonld[]',
     ...
     * Gets hydramember
     *
     * @return \MvApi\Model\BallotJsonld[]
     */
     ...
     * Sets hydramember
     *
     * @param \MvApi\Model\BallotJsonld[] $hydramember hydramember
     *
     * @return self
     */
    ...
    public function setHydratotalItems($hydratotal_items)
    {
        ...
        if (!is_null($hydratotal_items) && ($hydratotal_items < 0)) {
            throw new \InvalidArgumentException('invalid value for $hydratotal_items when calling InlineResponse2004., must be bigger than or equal to 0.');
        }
