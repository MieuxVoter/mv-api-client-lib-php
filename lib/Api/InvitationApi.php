...
class InvitationApi
{
    ...
    /**
     * Operation getForPollInvitationCollection
     *
    ...
    /**
     * Operation getForPollInvitationCollectionWithHttpInfo
     *
     * Retrieves the collection of Invitation resources.
     *
     * @param  string $id Universally Unique IDentifier (UUID) (required)
    ...
    /**
     * Operation getForPollInvitationCollectionAsync
     *
     * Retrieves the collection of Invitation resources.
     *
     * @param  string $id Universally Unique IDentifier (UUID) (required)
    ...
    /**
     * Operation getForPollInvitationCollectionAsyncWithHttpInfo
     *
     * Retrieves the collection of Invitation resources.
     *
     * @param  string $id Universally Unique IDentifier (UUID) (required)
    ...
    public function getForPollInvitationCollectionRequest($id, $page = 1)
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getForPollInvitationCollection'
            );
        }

        $resourcePath = '/polls/{id}/invitations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->getInvitationCollectionWithHttpInfo($page);
        return $response;
    }

    /**
     * Operation getInvitationCollectionWithHttpInfo
     *
     * Retrieves the collection of Invitation resources.
     *
     * @param  int $page The collection page number (optional, default to 1)
    ...
    /**
     * Operation getInvitationCollectionAsync
     *
     * Retrieves the collection of Invitation resources.
     *
     * @param  int $page The collection page number (optional, default to 1)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvitationCollectionAsync($page = 1)
    {
        return $this->getInvitationCollectionAsyncWithHttpInfo($page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInvitationCollectionAsyncWithHttpInfo
     *
     * Retrieves the collection of Invitation resources.
     *
     * @param  int $page The collection page number (optional, default to 1)
    ...
    /**
     * Create request for operation 'getInvitationCollection'
     *
     * @param  int $page The collection page number (optional, default to 1)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInvitationCollectionRequest($page = 1)
    {
    ...
    {
        list($response) = $this->getInvitationItemWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation getInvitationItemWithHttpInfo
     *
     * Retrieves a Invitation resource.
     *
     * @param  string $id Universally Unique IDentifier (UUID) (required)
    ...
    /**
     * Operation getInvitationItemAsync
     *
     * Retrieves a Invitation resource.
     *
     * @param  string $id Universally Unique IDentifier (UUID) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInvitationItemAsync($id)
    {
        return $this->getInvitationItemAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInvitationItemAsyncWithHttpInfo
     *
     * Retrieves a Invitation resource.
     *
     * @param  string $id Universally Unique IDentifier (UUID) (required)
    ...
    /**
     * Create request for operation 'getInvitationItem'
     *
     * @param  string $id Universally Unique IDentifier (UUID) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInvitationItemRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getInvitationItem'
            );
        }
