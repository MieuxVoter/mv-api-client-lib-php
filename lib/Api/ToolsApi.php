...
class ToolsApi
{
    ...
    /**
     * Operation getJsonResultFromTally
     *
     ...
     * @return void
     */
    public function getJsonResultFromTally()
    {
        $this->getJsonResultFromTallyWithHttpInfo();
    }

    /**
     * Operation getJsonResultFromTallyWithHttpInfo
     *
     * Resolves the provided tally.
     *
     *
     ...
     */
    public function getJsonResultFromTallyWithHttpInfo()
    {
        $request = $this->getJsonResultFromTallyRequest();
    ...
    /**
     * Operation getJsonResultFromTallyAsync
     *
     * Resolves the provided tally.
     *
     *
     ...
     */
    public function getJsonResultFromTallyAsync()
    {
        return $this->getJsonResultFromTallyAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getJsonResultFromTallyAsyncWithHttpInfo
     *
     * Resolves the provided tally.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getJsonResultFromTallyAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->getJsonResultFromTallyRequest();
    ...
    /**
     * Create request for operation 'getJsonResultFromTally'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getJsonResultFromTallyRequest()
    {

        $resourcePath = '/{tally}.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getSvgMeritProfileFromTally
     *
     ...
     * @return void
     */
    public function getSvgMeritProfileFromTally()
    {
        $this->getSvgMeritProfileFromTallyWithHttpInfo();
    }

    /**
     * Operation getSvgMeritProfileFromTallyWithHttpInfo
     *
     * Generates a merit profile as SVG of the provided tally.
     *
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSvgMeritProfileFromTallyWithHttpInfo()
    {
        $request = $this->getSvgMeritProfileFromTallyRequest();
    ...
    /**
     * Operation getSvgMeritProfileFromTallyAsync
     *
     * Generates a merit profile as SVG of the provided tally.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSvgMeritProfileFromTallyAsync()
    {
        return $this->getSvgMeritProfileFromTallyAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSvgMeritProfileFromTallyAsyncWithHttpInfo
     *
     * Generates a merit profile as SVG of the provided tally.
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSvgMeritProfileFromTallyAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->getSvgMeritProfileFromTallyRequest();
    ...
    /**
     * Create request for operation 'getSvgMeritProfileFromTally'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSvgMeritProfileFromTallyRequest()
    {

        $resourcePath = '/render/merit-profile.svg';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
